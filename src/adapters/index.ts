...
/**
 * Get the default schema name for a database configuration
 *
 * - PostgreSQL: 'public'
 * - MySQL: the database name (schema = database in MySQL)
 * - MSSQL: 'dbo'
 * - SQLite: 'main'
 *
 * @param config - Database configuration
 * @returns The default schema name for the database type
 */
export function getDefaultSchemaForConfig(config: DatabaseConfig): string {
  switch (config.type) {
