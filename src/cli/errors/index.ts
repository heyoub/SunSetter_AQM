...
const ERROR_METADATA: Record<ErrorCode, ErrorMetadata> = {
  ...
  [ERROR_CODES.CONNECTION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-001',
    retryable: true,
    category: 'connection',
  },
  [ERROR_CODES.CONNECTION_TIMEOUT]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-002',
    retryable: true,
    category: 'connection',
  },
  [ERROR_CODES.CONNECTION_REFUSED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-003',
    retryable: true,
    category: 'connection',
  },
  [ERROR_CODES.AUTHENTICATION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-004',
    retryable: false,
    category: 'connection',
  },
  [ERROR_CODES.SSL_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-005',
    retryable: false,
    category: 'connection',
  },
  [ERROR_CODES.CONNECTION_POOL_EXHAUSTED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-006',
    retryable: true,
    category: 'connection',
  },
  ...
  [ERROR_CODES.INTROSPECTION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-100',
    retryable: false,
  ...
  [ERROR_CODES.SCHEMA_NOT_FOUND]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-101',
    retryable: false,
    category: 'introspection',
  },
  [ERROR_CODES.TABLE_NOT_FOUND]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-102',
    retryable: false,
    category: 'introspection',
  },
  [ERROR_CODES.PERMISSION_DENIED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-103',
    retryable: false,
    category: 'introspection',
  },
  [ERROR_CODES.UNSUPPORTED_TYPE]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-104',
    retryable: false,
    category: 'introspection',
  },
  [ERROR_CODES.COMPOSITE_TYPE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-105',
    retryable: false,
    category: 'introspection',
  },
  ...
  [ERROR_CODES.TYPE_MAPPING_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-200',
    retryable: false,
    category: 'type',
  },
  [ERROR_CODES.UNKNOWN_POSTGRES_TYPE]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-201',
    retryable: false,
    category: 'type',
  },
  [ERROR_CODES.ARRAY_TYPE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-202',
    retryable: false,
    category: 'type',
  },
  [ERROR_CODES.ENUM_TYPE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-203',
    retryable: false,
    category: 'type',
  },
  [ERROR_CODES.JSON_PARSE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-204',
    retryable: false,
    category: 'type',
  },
  [ERROR_CODES.BINARY_DATA_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-205',
    retryable: false,
    category: 'type',
  },
  ...
  [ERROR_CODES.MIGRATION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-300',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.BATCH_INSERT_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-301',
    retryable: true,
    category: 'migration',
  },
  [ERROR_CODES.ROW_TRANSFORM_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-302',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.FK_RESOLUTION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-303',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.PRIMARY_KEY_MISSING]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-304',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.CIRCULAR_DEPENDENCY]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-305',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.STATE_SAVE_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-306',
    retryable: true,
    category: 'migration',
  },
  [ERROR_CODES.STATE_LOAD_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-307',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.MIGRATION_ABORTED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-308',
    retryable: false,
    category: 'migration',
  },
  [ERROR_CODES.RESUME_FAILED]: {
    ...
    fix: 'Start a fresh migration without --resume flag',
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-309',
    retryable: false,
    category: 'migration',
  },
  ...
  [ERROR_CODES.CONVEX_API_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-400',
    retryable: false,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_AUTH_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-401',
    retryable: false,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_RATE_LIMITED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-402',
    retryable: true,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_DEPLOYMENT_NOT_FOUND]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-403',
    retryable: false,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_FUNCTION_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-404',
    retryable: false,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_SCHEMA_MISMATCH]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-405',
    retryable: false,
    category: 'convex',
  },
  [ERROR_CODES.CONVEX_DOCUMENT_TOO_LARGE]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-406',
    retryable: false,
    category: 'convex',
  },
  ...
  [ERROR_CODES.CONFIG_INVALID]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-500',
    retryable: false,
    category: 'config',
  },
  [ERROR_CODES.CONFIG_MISSING_REQUIRED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-501',
    retryable: false,
    category: 'config',
  },
  [ERROR_CODES.CONFIG_FILE_NOT_FOUND]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-502',
    retryable: false,
    category: 'config',
  },
  [ERROR_CODES.CONFIG_PARSE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-503',
    retryable: false,
    category: 'config',
  },
  [ERROR_CODES.OUTPUT_DIR_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-504',
    retryable: false,
    category: 'config',
  },
  ...
  [ERROR_CODES.FS_READ_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-600',
    retryable: false,
    category: 'filesystem',
  },
  [ERROR_CODES.FS_WRITE_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-601',
    retryable: false,
    category: 'filesystem',
  },
  [ERROR_CODES.FS_PERMISSION_DENIED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-602',
    retryable: false,
    category: 'filesystem',
  },
  [ERROR_CODES.FS_PATH_NOT_FOUND]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-603',
    retryable: false,
    category: 'filesystem',
  },
  [ERROR_CODES.FS_DISK_FULL]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-604',
    retryable: false,
    category: 'filesystem',
  },
  ...
  [ERROR_CODES.VALIDATION_FAILED]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-700',
    retryable: false,
    category: 'validation',
  },
  [ERROR_CODES.INVALID_INPUT]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-701',
    retryable: false,
    category: 'validation',
  },
  [ERROR_CODES.CONSTRAINT_VIOLATION]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-702',
    retryable: false,
    category: 'validation',
  },
  [ERROR_CODES.DATA_INTEGRITY_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-703',
    retryable: false,
    category: 'validation',
  },
  ...
  [ERROR_CODES.UNKNOWN_ERROR]: {
    ...
    docsUrl: 'https://github.com/heyoub/sunsetter-aqm/wiki/errors#ERR-999',
    retryable: false,
    category: 'unknown',
  },
};
