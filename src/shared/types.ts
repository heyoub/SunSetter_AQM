...
// Re-export canonical naming/identifier utilities from utils/naming.
// These were historically defined here — the re-export preserves backward compat.
export {
  toCamelCase,
  toPascalCase,
  toKebabCase,
...
// (Reserved words, name conversion, and identifier utilities are now
//  defined in src/utils/naming.ts and re-exported at the top of this file.)
