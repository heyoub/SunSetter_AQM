...
export class WelcomeScreen {
  ...
  private render(): void {
    ...
    const menuList = blessed.list({
      ...
      height: 8,
      items: [
        '{#FF6B35-fg}[1]{/} 🚀 Start Migration     - Migrate database to Convex',
        '{#FF6B35-fg}[2]{/} 📝 Generate Schema     - Generate Convex schema only',
        '{#FF6B35-fg}[3]{/} 🔍 Introspect Database - View database structure',
        '{#FF6B35-fg}[4]{/} ❓ Help & Documentation',
        '{#FF6B35-fg}[Q]{/} 🚪 Quit',
      ],
      tags: true,
      keys: true,
